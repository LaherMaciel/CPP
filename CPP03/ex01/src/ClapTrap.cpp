...
/*   Updated: 2026/03/17 18:31:32 by lahermaciel      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	energyPoints = 10;
	attackDamage = 0;
	std::cout << "Default ClapTrap Constructor Called: ClapTrap Created!"
		<< std::endl;
}
...
void	ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << name << " attacked " << target << " causing "
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		hitPoints = 0;
		std::cout << name << " received " << amount
			<< " of Damage and is Totally Damaged!" << std::endl;
	}
	else
	{
		hitPoints -= amount;
		std::cout << name << " Received " << amount << " Damaged!"
			<< std::endl;
	}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	switch (energyPoints)
	{
		...
		default:
			...
			{
				hitPoints += amount;
				std::cout << name << " Received " << amount << " of Repair!"
					<< std::endl;
			}
			std::cout << name << " Current hitPoint = " << hitPoints << std::endl;
			energyPoints--;
