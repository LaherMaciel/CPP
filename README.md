...
[![C++](https://img.shields.io/badge/Language-C++98-green)](https://en.wikipedia.org/wiki/C%2B%2B)

> 42 School C++ curriculum — modules 00 through 09.

All modules compile with `-Wall -Wextra -Werror -std=c++98`.
...
| [CPP08](CPP08/README.md) | STL containers, iterators, algorithms | In progress |
| [CPP09](CPP09/README.md) | RPN calculator, Ford-Johnson sort | In progress |
